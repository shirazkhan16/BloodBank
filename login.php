...
<div class="header">
		<div class="logo">
			<h1><a href="index.php">
			                        <img src="Images/logo.jpg" alt="save life"></a></h1>
		</div>
	</div>
</div>
</div>
...
<div style="height:500px;">
   ...
   <table cellpadding="0" cellspacing="0" width="600px" height="300px" class="tableborder" style="margin:auto; background-color:skyblue; margin-top:100px;" >
     <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<tr><td>&nbsp;</td><td><input type="submit" value="Log In" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px;
 box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
