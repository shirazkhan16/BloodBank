...
<div class="wrap">
		<ul class="nav">
			...
			<li><a href="registration.php">Donar Registration</a></li>
...
<div style=" height:auto">
     ...
     <form method="post" enctype="multipart/form-data">
      <table cellpadding="1" cellspacing="1" width="1100px" style="margin:auto">
  <tr>            
            <td>
...
?>
  <tr><td  >
            ...
            <table cellpadding="0" cellspacing="0" width="700px" height="150px" style="margin:auto;background-color:skyblue; border:none;" 
			class="tableborder">


                <tr><td width="100px"  align="center" style="vertical-align:middle">

 <a href="doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="120px" 
 width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" /></a></td>


                    <td width="500px" height="50px" style="vertical-align:top">
                        

                        <table cellpadding="1" width="500px" height="150px" style="border">
           <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td><span class="title">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td><td>
<?php echo $data[1]; ?></td><td align="left" width="50%"></td></tr>
