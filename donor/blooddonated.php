...
<div style="height:400px; width:600px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:skyblue; border:2px solid red; box-shadow:4px 1px 20px black;">
...
?>
         ...
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
        <tr><td class="lefttd"  style="vertical-align:middle"> Date</td><td><input type="date" name="t2" required="required" /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr><td class="lefttd"  style="vertical-align:middle">No Of Units</td><td><input type="number" name="t3" min="1" max="10" required="required" pattern="[0-9]{1,10}" title="please enter only numbers between 1 to 10 for no. of units" /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
