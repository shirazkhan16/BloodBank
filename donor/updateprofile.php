...
<div style="height:400px; width:700px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:skyblue; border:2px solid red; box-shadow:4px 1px 20px black;">
 <form method="post">
