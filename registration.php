...
<div style="height:530px; width:700px; margin:auto; margin-top:10px; margin-bottom:20px; background-color:skyblue; border:2px solid red; box-shadow:4px 1px 20px black;">
...
<tr><td colspan="2">&nbsp;</td></tr>
                ...
                <tr><td  style=" padding-left:20px;" ><img src="Images/images-5.jpg" width="170px" class="shaddoww"/>&nbsp; </td>
...
<tr><td class="lefttd">Age</td><td><input type="number" name="t2" required="required" min="15" max="70" value="15" pattern="[0-9]{2,2}" title="please enter only  numbers between 15 to 70 for age" /></td></tr>

<tr><td class="lefttd">Mobile No</td><td><input type="number" name="t3" required="required"  maxlength="13" pattern="[0-9]{10}" value="+91" title="please enter only numbers between 10 to 11 for mobile no." /></td></tr>
...
<tr><td class="lefttd">E-Mail</td><td><input type="text" name="t5" pattern="[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+.com$" required="required" title="you must enter a valid email id"/></td></tr>
