...
<div class="header">
		<div class="logo">
			<h1><a href="Home.php"><img src="Images/logo.jpg" alt=""></a></h1>
		</div>
	</div>
</div>
</div>
...
<tr><td>&nbsp;</td><td><input type="submit" value="Log In" name="sbmt" style="border:0px; background:red; width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
