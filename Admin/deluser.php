...
<tr><td>&nbsp;</td><td><input type="submit" value="DELETE" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px;
