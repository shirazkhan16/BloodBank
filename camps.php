...
<div style="height:400px; width:100%; margin:auto; background-color:skyblue; border:2px solid red; box-shadow:4px 1px 20px black;">
    <div class="s_bg">
<div class="wrap">
<div class="main_cont">
     <div class="main">
...
$s="select * from camp,state,city where camp.state=state.state_id and camp.city=city.city_id";
    ...
    <tr><td style="font-size:24px; font-weight:bold; text-shadow:1px 1px 6px browm; padding-left:50px; padding-top:10px; padding-bottom:10px; 
	color:#925959"><?php echo $data[1]; ?></td></tr>
      <tr><td align="center"> 
   <a href="Admin/pic/<?php echo $data[5] ?>"data-lightbox="image-1"> <img src="Admin/pic/<?php echo $data[5] ?>" height="250px" width="460px"
   style="margin:auto; padding-left:20px" /></a></td></tr>
