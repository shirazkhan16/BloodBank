...
<div class="wrap">
    ...
    <div>
<div style="height:500px; width:100%; margin:auto; margin-top:10px; margin-bottom:10px; background-color:skyblue; border:2px solid red; box-shadow:4px 1px 20px black;">
